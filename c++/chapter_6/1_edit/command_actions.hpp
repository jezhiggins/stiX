...
namespace stiX {
  ...
  action make_append_action(size_t const from_index,
                            size_t const to_index,
                            size_t const destination,
                            command_extras const& extras);
  action make_change_action(size_t const from_index,
                            size_t const to_index,
                            size_t const destination,
                            command_extras const& extras);
  action make_delete_action(size_t const from_index,
                            size_t const to_index,
                            size_t const destination,
                            command_extras const& extras);
  action make_edit_action(size_t const from_index,
                          size_t const to_index,
                          size_t const destination,
                          command_extras const& extras);
  action make_filename_action(size_t const from_index,
                              size_t const to_index,
                              size_t const destination,
                              command_extras const& extras);
  action make_insert_action(size_t const from_index,
                            size_t const to_index,
                            size_t const destination,
                            command_extras const& extras);
  action make_move_action(size_t const from_index,
                          size_t const to_index,
                          size_t const destination,
                          command_extras const& extras);
  action make_print_action(size_t const from_index,
                           size_t const to_index,
                           size_t const destination,
                           command_extras const& extras);
  action make_print_next_line_action(size_t const from_index,
                                     size_t const to_index,
                                     size_t const destination,
                                     command_extras const& extras);
  action make_quit_action(size_t const from_index,
                          size_t const to_index,
                          size_t const destination,
                          command_extras const& extras);
  action make_read_file_action(size_t const from_index,
                               size_t const to_index,
                               size_t const destination,
                               command_extras const& extras);
  action make_substitute_action(size_t const from_index,
                                size_t const to_index,
                                size_t const destination,
                                command_extras const& extras);
  action make_write_file_action(size_t const from_index,
                                size_t const to_index,
                                size_t const destination,
                                command_extras const& extras);
  action make_line_index_action(size_t const from_index,
                                size_t const to_index,
                                size_t const destination,
                                command_extras const& extras);
}
