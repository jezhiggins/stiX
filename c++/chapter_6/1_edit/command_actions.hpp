...
namespace stiX {
  ...
  void filename_action(std::ostream& out, std::string_view filename, edit_buffer& buffer);
  void write_to_file_action(std::ostream& out, size_t from, size_t to, std::string_view filename, edit_buffer& buffer);
  void read_from_file_action(std::ostream& out, size_t before, std::string_view filename, edit_buffer& buffer);
  void edit_file_action(std::ostream& out, std::string_view filename, edit_buffer& buffer);
  ...
  void global_action(size_t from, size_t to, std::string_view pattern, bool match, stiX::parsed_command const& action,
                     std::istream& in, std::ostream& out, edit_buffer& buffer);
